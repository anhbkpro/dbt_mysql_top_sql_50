...
insert into customers__find_customer_referee (id, name, referee_id) values ('1', 'Will', null)
insert into customers__find_customer_referee (id, name, referee_id) values ('2', 'Jane', null)
insert into customers__find_customer_referee (id, name, referee_id) values ('3', 'Alex', '2')
insert into customers__find_customer_referee (id, name, referee_id) values ('4', 'Bill', null)
